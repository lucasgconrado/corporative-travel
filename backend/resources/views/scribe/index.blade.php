...
<head>
    ...
    <title>Laravel Corporate Travel API by Bicalho</title>
    ...
    <script>
        var tryItOutBaseUrl = "http://localhost:8000/api";
        var useCsrf = Boolean();
    ...
    <div id="toc">
                ...
                <li class="tocify-item level-1" data-unique="autenticacao">
                    <a href="#autenticacao">Autenticação</a>
                                ...
                                <a href="#autenticacao-POSTapi-register">POST api/register</a>
                            </li>
                ...
                <li class="tocify-item level-1" data-unique="pedidos">
                    <a href="#pedidos">Pedidos</a>
                                ...
                                <a href="#pedidos-POSTapi-orders">Criar um novo pedido</a>
                            </li>
                                                                                <li class="tocify-item level-2" data-unique="pedidos-GETapi-orders">
                                <a href="#pedidos-GETapi-orders">GET api/orders</a>
                            </li>
                                                                                <li class="tocify-item level-2" data-unique="pedidos-GETapi-orders--id-">
                                <a href="#pedidos-GETapi-orders--id-">Detalhar pedido</a>
                            </li>
                                                                                <li class="tocify-item level-2" data-unique="pedidos-PATCHapi-orders--id--status">
                                <a href="#pedidos-PATCHapi-orders--id--status">Atualizar status do pedido</a>
                            </li>
                                                                        </ul>
                            </ul>
            </div>
...
<p>API para gerenciamento de viagens corporativas, incluindo autenticação JWT e pedidos de viagem.</p>
<aside>
    <strong>Base URL</strong>: <code>http://localhost:8000/api</code>
</aside>
<p>Use esta documentação para explorar os endpoints disponíveis e entender como integrar com o front-end em Vue.js.</p>
...
<p>This API is not authenticated.</p>
        ...
        <h1 id="autenticacao">Autenticação</h1>
                                ...
                                <h2 id="autenticacao-POSTapi-register">POST api/register</h2>
...
<small>string</small>&nbsp;
 ...
 &nbsp;
               ...
               data-component="body">
    <br>
<p>Nome do usuário. Exemplo: Lucas Example: <code>architecto</code></p>
        </div>
                <div style=" padding-left: 28px;  clear: unset;">
...
<small>string</small>&nbsp;
 ...
 &nbsp;
               ...
               data-component="body">
    <br>
<p>Email do usuário. Exemplo: lucas@example.com Example: <code>gbailey@example.net</code></p>
        </div>
                <div style=" padding-left: 28px;  clear: unset;">
...
<small>string</small>&nbsp;
 ...
 &nbsp;
               ...
               data-component="body">
    <br>
<p>Senha do usuário. Exemplo: 123456 Example: <code>|]|{+-</code></p>
        </div>
        </form>
...
<p>Autentica um usuário com email e senha, retornando um token JWT.</p>
...
<small>string</small>&nbsp;
 ...
 &nbsp;
                <input type="text" style="display: none"
                              name="name"                data-endpoint="POSTapi-login"
               value="architecto"
               data-component="body">
    <br>
<p>Nome do usuário. Exemplo: Lucas Example: <code>architecto</code></p>
...
<p>Invalida o token JWT atual, encerrando a sessão do usuário.</p>
...
<div class="bash-example">
    <pre><code class="language-bash">curl --request POST \
    "http://localhost:8000/api/api/logout" \
    --header "Content-Type: application/json" \
    --header "Accept: application/json" \
    --data "{
    \"name\": \"architecto\",
...
<small>string</small>&nbsp;
 ...
 &nbsp;
                <input type="text" style="display: none"
                              name="name"                data-endpoint="POSTapi-logout"
               value="architecto"
               data-component="body">
    <br>
<p>Nome do usuário. Exemplo: Lucas Example: <code>architecto</code></p>
...
<p>Retorna os dados do usuário autenticado pelo token JWT.</p>
...
<div class="bash-example">
    ...
    --get "http://localhost:8000/api/api/me" \
    --header "Content-Type: application/json" \
    --header "Accept: application/json" \
    --data "{
    \"name\": \"architecto\",
...
<small>string</small>&nbsp;
 ...
 &nbsp;
                <input type="text" style="display: none"
                              name="name"                data-endpoint="GETapi-me"
               value="architecto"
               data-component="body">
    <br>
<p>Nome do usuário. Exemplo: Lucas Example: <code>architecto</code></p>
...
<small>string</small>&nbsp;
 ...
 &nbsp;
                <input type="text" style="display: none"
                              name="email"                data-endpoint="GETapi-me"
               value="gbailey@example.net"
               data-component="body">
    <br>
<p>Email do usuário. Exemplo: lucas@example.com Example: <code>gbailey@example.net</code></p>
...
<small>string</small>&nbsp;
 ...
 &nbsp;
                <input type="text" style="display: none"
                              name="password"                data-endpoint="GETapi-me"
               value="|]|{+-"
               data-component="body">
    <br>
<p>Senha do usuário. Exemplo: 123456 Example: <code>|]|{+-</code></p>
                ...
                <h1 id="pedidos">Pedidos</h1>
                                ...
                                <h2 id="pedidos-POSTapi-orders">Criar um novo pedido</h2>

<p>
<small class="badge badge-darkred">requires authentication</small>
</p>

<p>Cria um pedido de viagem para o usuário autenticado.</p>
...
<div class="bash-example">
    <pre><code class="language-bash">curl --request POST \
    "http://localhost:8000/api/api/orders?status=architecto&amp;destino=architecto&amp;data_inicio=architecto&amp;data_fim=architecto" \
    --header "Content-Type: application/json" \
    --header "Accept: application/json" \
    --data "{
    \"solicitante\": \"architecto\",
    \"destino\": \"architecto\",
    \"data_ida\": \"architecto\",
    \"data_volta\": \"architecto\"
}"
</code></pre></div>
...
<div class="javascript-example">
    <pre><code class="language-javascript">const url = new URL(
    "http://localhost:8000/api/api/orders"
);

const params = {
    "status": "architecto",
    "destino": "architecto",
    "data_inicio": "architecto",
    "data_fim": "architecto",
};
Object.keys(params)
...
<i>optional</i> &nbsp;
 &nbsp;
    ...
    <br>
<p>Filtrar por status. Exemplo: aprovado Example: <code>architecto</code></p>
            </div>
                                    <div style="padding-left: 28px; clear: unset;">
                <b style="line-height: 2;"><code>destino</code></b>&nbsp;&nbsp;
<small>string</small>&nbsp;
<i>optional</i> &nbsp;
 &nbsp;
                <input type="text" style="display: none"
                              name="destino"                data-endpoint="POSTapi-orders"
               value="architecto"
               data-component="query">
    <br>
<p>Filtrar por destino. Exemplo: São Paulo Example: <code>architecto</code></p>
            </div>
                                    <div style="padding-left: 28px; clear: unset;">
...
<i>optional</i> &nbsp;
 &nbsp;
                <input type="text" style="display: none"
                              name="data_inicio"                data-endpoint="POSTapi-orders"
               value="architecto"
               data-component="query">
    <br>
<p>date Filtrar por data inicial. Exemplo: 2026-03-01 Example: <code>architecto</code></p>
            </div>
                                    <div style="padding-left: 28px; clear: unset;">
...
<i>optional</i> &nbsp;
 &nbsp;
                <input type="text" style="display: none"
                              name="data_fim"                data-endpoint="POSTapi-orders"
               value="architecto"
               data-component="query">
    <br>
<p>date Filtrar por data final. Exemplo: 2026-03-31 Example: <code>architecto</code></p>
            </div>
                        <h4 class="fancy-heading-panel"><b>Body Parameters</b></h4>
        <div style=" padding-left: 28px;  clear: unset;">
            <b style="line-height: 2;"><code>solicitante</code></b>&nbsp;&nbsp;
<small>string</small>&nbsp;
 &nbsp;
 &nbsp;
                <input type="text" style="display: none"
                              name="solicitante"                data-endpoint="POSTapi-orders"
               value="architecto"
               data-component="body">
    <br>
<p>Nome do solicitante. Exemplo: Lucas Example: <code>architecto</code></p>
        </div>
                <div style=" padding-left: 28px;  clear: unset;">
            <b style="line-height: 2;"><code>destino</code></b>&nbsp;&nbsp;
<small>string</small>&nbsp;
 ...
 &nbsp;
               ...
               data-component="body">
    <br>
<p>Destino da viagem. Exemplo: São Paulo Example: <code>architecto</code></p>
        </div>
                <div style=" padding-left: 28px;  clear: unset;">
            <b style="line-height: 2;"><code>data_ida</code></b>&nbsp;&nbsp;
<small>date</small>&nbsp;
 &nbsp;
 &nbsp;
                <input type="text" style="display: none"
                              name="data_ida"                data-endpoint="POSTapi-orders"
               value="architecto"
               data-component="body">
    <br>
<p>Data de ida. Exemplo: 2026-03-10 Example: <code>architecto</code></p>
        </div>
                <div style=" padding-left: 28px;  clear: unset;">
            <b style="line-height: 2;"><code>data_volta</code></b>&nbsp;&nbsp;
<small>date</small>&nbsp;
 &nbsp;
 &nbsp;
                <input type="text" style="display: none"
                              name="data_volta"                data-endpoint="POSTapi-orders"
               value="architecto"
               data-component="body">
    <br>
<p>Data de volta. Exemplo: 2026-03-15 Example: <code>architecto</code></p>
        </div>
        </form>

                    <h2 id="pedidos-GETapi-orders">GET api/orders</h2>
...
<div class="bash-example">
    <pre><code class="language-bash">curl --request GET \
    --get "http://localhost:8000/api/api/orders?status=architecto&amp;destino=architecto&amp;data_inicio=architecto&amp;data_fim=architecto" \
    --header "Content-Type: application/json" \
...
<i>optional</i> &nbsp;
 &nbsp;
                <input type="text" style="display: none"
                              name="destino"                data-endpoint="GETapi-orders"
               value="architecto"
               data-component="query">
    <br>
<p>Filtrar por destino. Exemplo: São Paulo Example: <code>architecto</code></p>
...
<i>optional</i> &nbsp;
 &nbsp;
                <input type="text" style="display: none"
                              name="data_inicio"                data-endpoint="GETapi-orders"
               value="architecto"
               data-component="query">
    <br>
<p>date Filtrar por data inicial. Exemplo: 2026-03-01 Example: <code>architecto</code></p>
...
<i>optional</i> &nbsp;
 &nbsp;
                <input type="text" style="display: none"
                              name="data_fim"                data-endpoint="GETapi-orders"
               value="architecto"
               data-component="query">
    <br>
<p>date Filtrar por data final. Exemplo: 2026-03-31 Example: <code>architecto</code></p>
                    ...
                    <h2 id="pedidos-GETapi-orders--id-">Detalhar pedido</h2>

<p>
<small class="badge badge-darkred">requires authentication</small>
</p>

<p>Retorna os dados de um pedido específico do usuário autenticado.</p>
...
<div class="bash-example">
    <pre><code class="language-bash">curl --request GET \
    --get "http://localhost:8000/api/api/orders/16?status=architecto&amp;destino=architecto&amp;data_inicio=architecto&amp;data_fim=architecto" \
    --header "Content-Type: application/json" \
    --header "Accept: application/json"</code></pre></div>
...
<div class="javascript-example">
    <pre><code class="language-javascript">const url = new URL(
    "http://localhost:8000/api/api/orders/16"
);
...
<small>integer</small>&nbsp;
 ...
 &nbsp;
               ...
               data-component="url">
    <br>
<p>ID do pedido. Exemplo: 1 Example: <code>16</code></p>
            </div>
                        <h4 class="fancy-heading-panel"><b>Query Parameters</b></h4>
                                    <div style="padding-left: 28px; clear: unset;">
                <b style="line-height: 2;"><code>status</code></b>&nbsp;&nbsp;
...
<i>optional</i> &nbsp;
 &nbsp;
                <input type="text" style="display: none"
                              name="status"                data-endpoint="GETapi-orders--id-"
               value="architecto"
               data-component="query">
    <br>
<p>Filtrar por status. Exemplo: aprovado Example: <code>architecto</code></p>
...
<i>optional</i> &nbsp;
 &nbsp;
                <input type="text" style="display: none"
                              name="destino"                data-endpoint="GETapi-orders--id-"
               value="architecto"
               data-component="query">
    <br>
<p>Filtrar por destino. Exemplo: São Paulo Example: <code>architecto</code></p>
...
<i>optional</i> &nbsp;
 &nbsp;
                <input type="text" style="display: none"
                              name="data_inicio"                data-endpoint="GETapi-orders--id-"
               value="architecto"
               data-component="query">
    <br>
<p>date Filtrar por data inicial. Exemplo: 2026-03-01 Example: <code>architecto</code></p>
...
<i>optional</i> &nbsp;
 &nbsp;
                <input type="text" style="display: none"
                              name="data_fim"                data-endpoint="GETapi-orders--id-"
               value="architecto"
               data-component="query">
    <br>
<p>date Filtrar por data final. Exemplo: 2026-03-31 Example: <code>architecto</code></p>
                    ...
                    <h2 id="pedidos-PATCHapi-orders--id--status">Atualizar status do pedido</h2>

<p>
<small class="badge badge-darkred">requires authentication</small>
</p>

<p>Permite que apenas administradores atualizem o status de um pedido.</p>
...
<div class="bash-example">
    ...
    "http://localhost:8000/api/api/orders/16/status?status=architecto&amp;destino=architecto&amp;data_inicio=architecto&amp;data_fim=architecto" \
    --header "Content-Type: application/json" \
    --header "Accept: application/json" \
    --data "{
    \"status\": \"architecto\"
...
<div class="javascript-example">
    <pre><code class="language-javascript">const url = new URL(
    "http://localhost:8000/api/api/orders/16/status"
);
...
<code class="language-json" style="max-height: 300px;">{
    &quot;error&quot;: &quot;N&atilde;o &eacute; poss&iacute;vel cancelar ap&oacute;s aprova&ccedil;&atilde;o&quot;
}</code>
 </pre>
            <blockquote>
...
<small>integer</small>&nbsp;
 ...
 &nbsp;
                <input type="number" style="display: none"
               step="any"               name="id"                data-endpoint="PATCHapi-orders--id--status"
               value="16"
               data-component="url">
    <br>
<p>ID do pedido. Exemplo: 1 Example: <code>16</code></p>
...
<i>optional</i> &nbsp;
 &nbsp;
                <input type="text" style="display: none"
                              name="destino"                data-endpoint="PATCHapi-orders--id--status"
               value="architecto"
               data-component="query">
    <br>
<p>Filtrar por destino. Exemplo: São Paulo Example: <code>architecto</code></p>
...
<i>optional</i> &nbsp;
 &nbsp;
                <input type="text" style="display: none"
                              name="data_inicio"                data-endpoint="PATCHapi-orders--id--status"
               value="architecto"
               data-component="query">
    <br>
<p>date Filtrar por data inicial. Exemplo: 2026-03-01 Example: <code>architecto</code></p>
...
<i>optional</i> &nbsp;
 &nbsp;
                <input type="text" style="display: none"
                              name="data_fim"                data-endpoint="PATCHapi-orders--id--status"
               value="architecto"
               data-component="query">
    <br>
<p>date Filtrar por data final. Exemplo: 2026-03-31 Example: <code>architecto</code></p>
...
<small>string</small>&nbsp;
 ...
 &nbsp;
               ...
               data-component="body">
    <br>
<p>Novo status do pedido. Exemplo: aprovado Example: <code>architecto</code></p>
        </div>
        </form>
