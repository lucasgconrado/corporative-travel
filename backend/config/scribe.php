...
return [
    ...
    'title' => config('app.name').' Corporate Travel API by Bicalho',

    // A short description of your API. Will be included in the docs webpage, Postman collection and OpenAPI spec.
    'description' => 'API para gerenciamento de viagens corporativas, incluindo autenticação JWT e pedidos de viagem.',

    // Text to place in the "Introduction" section, right after the `description`. Markdown and HTML are supported.
    'intro_text' => 'Use esta documentação para explorar os endpoints disponíveis e entender como integrar com o front-end em Vue.js.',
